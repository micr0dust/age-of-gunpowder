...
# By Microdust
#########################################################################################################
execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=ctrl,score_buildType=0,score_resourceType_min=2,score_resourceType=2,c=1] ~ ~ ~ scoreboard players set @e[tag=ctrl,score_AI_b_min=1,score_AI_b=1,c=1] AI_b 2
