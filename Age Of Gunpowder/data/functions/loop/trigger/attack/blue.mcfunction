...
execute @e[tag=cmd,c=1,score_bswordman_min=1,score_bspearman=0] ~ ~ ~ execute @e[tag=boutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:2899L,UUIDLeast:2899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.13f}],Silent:1,Tags:["attacker","battacker","blue"]}
execute @e[tag=cmd,c=1,score_bswordman=0,score_bspearman_min=1] ~ ~ ~ execute @e[tag=boutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:2899L,UUIDLeast:2899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.13f}],Silent:1,Tags:["attacker","battacker","blue"]}
execute @e[tag=cmd,c=1,score_bswordman_min=1,score_bspearman_min=1] ~ ~ ~ execute @e[tag=boutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:2899L,UUIDLeast:2899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.13f}],Silent:1,Tags:["attacker","battacker","blue"]}
execute @e[tag=cmd,c=1,score_bswordman=0,score_bspearman=0,score_bmusket_min=1] ~ ~ ~ execute @e[tag=boutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:2899L,UUIDLeast:2899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.19f}],Silent:1,Tags:["attacker","battacker","blue"]}
...
scoreboard players operation @e[tag=cmd,c=1] b_musket = @e[tag=cmd,c=1] bmusket
scoreboard players operation @e[tag=cmd,c=1] b_swordman = @e[tag=cmd,c=1] bswordman
scoreboard players operation @e[tag=cmd,c=1] b_spearman = @e[tag=cmd,c=1] bspearman
scoreboard players operation @e[tag=cmd,c=1] b_rider = @e[tag=cmd,c=1] brider
