...
scoreboard players operation @e[tag=cmd,c=1,c=1] i -= @e[tag=cmd,c=1,c=1] rteam
execute @e[tag=cmd,c=1,c=1,score_i_min=1] ~ ~ ~ execute @p[team=red] ~ ~ ~ tellraw @p[team=red] ["",{"text":"♥ ","color":"red"},{"score":{"name":"@e[tag=building,c=1,r=4]","objective":"health"}},{"translate":"aop.enemy","color":"red"}]
execute @e[tag=cmd,c=1,c=1,score_i=-1] ~ ~ ~ execute @p[team=red] ~ ~ ~ tellraw @p[team=red] ["",{"text":"♥ ","color":"red"},{"score":{"name":"@e[tag=building,c=1,r=4]","objective":"health"}},{"translate":"aop.enemy","color":"red"}]
execute @e[tag=cmd,c=1,c=1,score_i_min=0,score_i=0] ~ ~ ~ execute @p[team=red] ~ ~ ~ tellraw @p[team=red] ["",{"text":"♥ ","color":"red"},{"score":{"name":"@e[tag=building,c=1,r=4]","objective":"health"}},{"translate":"aop.ally","color":"dark_green"}]
...
execute @e[tag=building,c=1] ~ ~ ~ execute @e[tag=blue,r=0,c=1] ~ ~ ~ tellraw @p[team=red] ["",{"selector":"@a[team=blue]"},{"text":" "}]
execute @e[tag=building,c=1] ~ ~ ~ execute @e[tag=yellow,r=0,c=1] ~ ~ ~ tellraw @p[team=red] ["",{"selector":"@a[team=yellow]"},{"text":" "}]
execute @e[tag=building,c=1] ~ ~ ~ execute @e[tag=green,r=0,c=1] ~ ~ ~ tellraw @p[team=red] ["",{"selector":"@a[team=green]"},{"text":" "}]
