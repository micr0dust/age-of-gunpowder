...
scoreboard players operation @e[tag=cmd,c=1,c=1] i -= @e[tag=cmd,c=1,c=1] gteam
execute @e[tag=cmd,c=1,c=1,score_i_min=1] ~ ~ ~ execute @p[team=green] ~ ~ ~ tellraw @p[team=green] ["",{"text":"♥ ","color":"red"},{"score":{"name":"@e[tag=building,c=1,r=4]","objective":"health"}},{"translate":"aop.enemy","color":"red"}]
execute @e[tag=cmd,c=1,c=1,score_i=-1] ~ ~ ~ execute @p[team=green] ~ ~ ~ tellraw @p[team=green] ["",{"text":"♥ ","color":"red"},{"score":{"name":"@e[tag=building,c=1,r=4]","objective":"health"}},{"translate":"aop.enemy","color":"red"}]
execute @e[tag=cmd,c=1,c=1,score_i_min=0,score_i=0] ~ ~ ~ execute @p[team=green] ~ ~ ~ tellraw @p[team=green] ["",{"text":"♥ ","color":"red"},{"score":{"name":"@e[tag=building,c=1,r=4]","objective":"health"}},{"translate":"aop.ally","color":"dark_green"}]
