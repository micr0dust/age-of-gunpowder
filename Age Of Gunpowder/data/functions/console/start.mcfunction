...
execute @e[tag=cmd,c=1,score_ralive=0] ~ ~ ~ kill @e[tag=red]
execute @e[tag=cmd,c=1,score_balive=0] ~ ~ ~ kill @e[tag=blue]
execute @e[tag=cmd,c=1,score_yalive=0] ~ ~ ~ kill @e[tag=yellow]
execute @e[tag=cmd,c=1,score_galive=0] ~ ~ ~ kill @e[tag=green]
