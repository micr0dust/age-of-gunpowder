...
execute @e[tag=cmd,score_yfield_gun_min=1] ~ ~ ~ tellraw @p[team=yellow] ["",{"text":"[","color":"yellow"},{"translate":"aop.cannon","clickEvent":{"action":"run_command","value":"/trigger building set 9"},"hoverEvent":{"action":"show_text","value":[{"translate":"aop.cannon.hover"}]}},{"text":"] ","color":"yellow"},{"text":"100","color":"dark_green"},{"text":" 100","color":"gold"}]
