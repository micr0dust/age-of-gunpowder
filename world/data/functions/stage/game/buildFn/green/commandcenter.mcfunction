...
execute @e[tag=cmd,c=1,score_branch_min=1,score_branch=1] ~ ~ ~ tellraw @p[team=green] ["",{"text":"[","color":"yellow"},{"translate":"aop.savegame","color":"white","clickEvent":{"action":"run_command","value":"/function loop:trigger/savegame/save_A/savegame"},"hoverEvent":{"action":"show_text","value":[{"translate":"aop.savegame.hover"}]}},{"text":"]","color":"yellow"}]
