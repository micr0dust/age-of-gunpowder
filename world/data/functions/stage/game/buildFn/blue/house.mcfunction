...
execute @e[name=house,tag=blue] ~ ~ ~ scoreboard players add @e[tag=cmd] i 4
execute @e[tag=blue] ~ ~ ~ execute @e[tag=s,type=!llama,r=0,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd] l 1
