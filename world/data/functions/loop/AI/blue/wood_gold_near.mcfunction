...
# By Microdust
#########################################################################################################
execute @e[tag=blue,score_connect_min=1] ~ ~ ~ execute @e[tag=ctrl,score_buildType=0,score_resourceType_min=1,score_resourceType=2,r=12] ~ ~ ~ scoreboard players set @e[tag=ctrl,score_AI_b_min=1,score_AI_b=1,score_resourceType_min=1,score_resourceType=2,c=1] AI_b 2
...
execute @e[tag=ctrl,score_AI_b_min=2,score_AI_b=2,score_resourceType_min=0,score_resourceType=2] ~ ~1 ~ scoreboard players remove @e[tag=cmd,c=1] bmanpower 500
