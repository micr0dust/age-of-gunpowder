...
execute @e[tag=cmd,score_j_min=21,score_j=21] ~ ~ ~ execute @e[tag=cmd,score_bteam_min=1,score_bteam=1] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team1,c=1,r=36] ~ ~ ~ tp @e[tag=btarget] ~ 48 ~
execute @e[tag=cmd,score_j_min=21,score_j=21] ~ ~ ~ execute @e[tag=cmd,score_bteam_min=2,score_bteam=2] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team2,c=1,r=36] ~ ~ ~ tp @e[tag=btarget] ~ 48 ~
execute @e[tag=cmd,score_j_min=21,score_j=21] ~ ~ ~ execute @e[tag=cmd,score_bteam_min=3,score_bteam=3] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team3,c=1,r=36] ~ ~ ~ tp @e[tag=btarget] ~ 48 ~
...
execute @e[tag=cmd,score_j_min=20,score_j=20] ~ ~ ~ execute @e[tag=building,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=btarget] ~ ~ ~ function loop:ai/blue/change_target unless @e[tag=building,score_AI_b=-1,c=1,r=5]
