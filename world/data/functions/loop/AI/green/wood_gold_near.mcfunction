...
# By Microdust
#########################################################################################################
execute @e[tag=green,score_connect_min=1] ~ ~ ~ execute @e[tag=ctrl,score_buildType=0,score_resourceType_min=1,score_resourceType=2,r=12] ~ ~ ~ scoreboard players set @e[tag=ctrl,score_AI_g_min=1,score_AI_g=1,score_resourceType_min=1,score_resourceType=2,c=1] AI_g 2
