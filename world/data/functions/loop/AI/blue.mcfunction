...
execute @e[tag=cmd,score_bteam_min=1,score_bteam=1] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team1,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
execute @e[tag=cmd,score_bteam_min=2,score_bteam=2] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team2,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
execute @e[tag=cmd,score_bteam_min=3,score_bteam=3] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team3,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
execute @e[tag=cmd,score_bteam_min=4,score_bteam=4] ~ ~ ~ execute @e[name=commandcenter,tag=blue,c=1] ~ ~ ~ execute @e[tag=s,team=!team4,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=blue,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/blue/cost/spearman if @e[tag=cmd,score_bmanpower_min=80,score_bwood_min=10,score_i=-1,score_bflintlock=0,score_k=2]
...
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=blue,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/blue/cost/matchlock if @e[tag=cmd,score_bmanpower_min=80,score_bgold_min=10,score_i=-1,score_bflintlock=0,score_k=2]
...
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=blue,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/blue/cost/musket if @e[tag=cmd,score_bmanpower_min=80,score_bgold_min=10,score_i=-1,score_bflintlock_min=1,score_k=2]
...
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=blue,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/blue/cost/musket if @e[tag=cmd,score_bmanpower_min=80,score_bwood_min=10,score_bwood_ef=0,score_i=-1,score_bflintlock_min=1,score_k=2]
...
#極難AI作弊
execute @e[tag=cmd,score_time_min=100,score_time=100,score_balive_min=1,score_Bdifficulty_min=5,score_bAI=1,score_bflintlock=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=blue,name=barracks,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"swordman",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","blue"]}
execute @e[tag=cmd,score_time_min=100,score_time=100,score_balive_min=1,score_Bdifficulty_min=5,score_bAI=1,score_bflintlock_min=1,score_brifling=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=blue,name=barracks,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"musket",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","blue"]}
execute @e[tag=cmd,score_time_min=100,score_time=100,score_balive_min=1,score_Bdifficulty_min=5,score_bAI=1] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=blue,name=stable,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"light_cavalry",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","blue"]}
execute @e[tag=cmd,score_time_min=100,score_time=100,score_balive_min=1,score_Bdifficulty_min=5,score_bAI=1,score_brifling_min=1] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=blue,name=barracks,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"rifleman",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","blue"]}
...
#餘額買軍營
function loop:ai/blue/barracks if @e[tag=cmd,score_bwood_min=600,score_bgold_min=700]
#餘額買馬廄(極難)
function loop:ai/blue/stable if @e[tag=cmd,score_bwood_min=600,score_bgold_min=400]
#餘額買軍營
...
#餘額升級(極難)
execute @e[name=factory,tag=blue,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/blue/cost/rifling if @e[tag=cmd,score_bgold_min=500,score_bflintlock_min=1,score_brifling=0]
#孤立資源領土自刪
...
#投降
execute @e[tag=cmd,score_bmanpower_ef=7,score_AI_surrender_min=1] ~ ~ ~ execute @e[name=commandcenter,tag=blue] ~ ~ ~ function @@@:suicide if @e[tag=!blue,type=vindication_illager,r=33]
#execute @e[name=commandcenter,tag=blue] ~ ~ ~ function @@@:suicide if @e[tag=!blue,type=shulker,name=territory,r=40]
#自動進攻
function loop:ai/blue/module/attack if @e[tag=cmd,score_j_min=1]
function loop:ai/blue/module/attack if @e[tag=cmd,score_j=0,score_Bdifficulty_min=2]
