...
# By Microdust
#########################################################################################################
execute @e[tag=red,score_connect_min=1] ~ ~ ~ execute @e[tag=ctrl,score_buildType=0,score_resourceType_min=1,score_resourceType=2,r=12] ~ ~ ~ scoreboard players set @e[tag=ctrl,score_AI_r_min=1,score_AI_r=1,score_resourceType_min=1,score_resourceType=2,c=1] AI_r 2
...
execute @e[tag=ctrl,score_AI_r_min=2,score_AI_r=2,score_resourceType_min=0,score_resourceType=2] ~ ~1 ~ scoreboard players remove @e[tag=cmd,c=1] rmanpower 500
