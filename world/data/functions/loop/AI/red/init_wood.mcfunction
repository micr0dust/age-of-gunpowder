...
# By Microdust
#########################################################################################################
execute @e[name=commandcenter,tag=red,c=1] ~ ~ ~ execute @e[tag=ctrl,score_buildType=0,score_resourceType_min=1,score_resourceType=1,c=1] ~ ~ ~ scoreboard players set @e[tag=ctrl,score_AI_r_min=1,score_AI_r=1,c=1] AI_r 2
