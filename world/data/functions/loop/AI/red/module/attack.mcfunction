...
execute @e[tag=cmd,score_j_min=21,score_j=21] ~ ~ ~ execute @e[tag=cmd,score_rteam_min=1,score_rteam=1] ~ ~ ~ execute @e[name=commandcenter,tag=red,c=1] ~ ~ ~ execute @e[tag=s,team=!team1,c=1,r=36] ~ ~ ~ tp @e[tag=rtarget] ~ 48 ~
execute @e[tag=cmd,score_j_min=21,score_j=21] ~ ~ ~ execute @e[tag=cmd,score_rteam_min=2,score_rteam=2] ~ ~ ~ execute @e[name=commandcenter,tag=red,c=1] ~ ~ ~ execute @e[tag=s,team=!team2,c=1,r=36] ~ ~ ~ tp @e[tag=rtarget] ~ 48 ~
execute @e[tag=cmd,score_j_min=21,score_j=21] ~ ~ ~ execute @e[tag=cmd,score_rteam_min=3,score_rteam=3] ~ ~ ~ execute @e[name=commandcenter,tag=red,c=1] ~ ~ ~ execute @e[tag=s,team=!team3,c=1,r=36] ~ ~ ~ tp @e[tag=rtarget] ~ 48 ~
...
execute @e[tag=cmd,score_j_min=20,score_j=20] ~ ~ ~ execute @e[tag=building,score_AI_r=-1,c=1] ~ ~ ~ execute @e[tag=rtarget] ~ ~ ~ function loop:ai/red/change_target unless @e[tag=building,score_AI_r=-1,c=1,r=5]
