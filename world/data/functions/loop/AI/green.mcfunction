...
execute @e[tag=cmd,score_gteam_min=1,score_gteam=1] ~ ~ ~ execute @e[name=commandcenter,tag=green,c=1] ~ ~ ~ execute @e[tag=s,team=!team1,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
execute @e[tag=cmd,score_gteam_min=2,score_gteam=2] ~ ~ ~ execute @e[name=commandcenter,tag=green,c=1] ~ ~ ~ execute @e[tag=s,team=!team2,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
execute @e[tag=cmd,score_gteam_min=3,score_gteam=3] ~ ~ ~ execute @e[name=commandcenter,tag=green,c=1] ~ ~ ~ execute @e[tag=s,team=!team3,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
execute @e[tag=cmd,score_gteam_min=4,score_gteam=4] ~ ~ ~ execute @e[name=commandcenter,tag=green,c=1] ~ ~ ~ execute @e[tag=s,team=!team4,c=1,r=36] ~ ~ ~ scoreboard players set @e[tag=cmd] j 1
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_g=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=green,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/green/cost/spearman if @e[tag=cmd,score_gmanpower_min=80,score_gwood_min=10,score_i=-1,score_gflintlock=0,score_k=2]
...
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_g=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=green,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/green/cost/matchlock if @e[tag=cmd,score_gmanpower_min=80,score_ggold_min=10,score_i=-1,score_gflintlock=0,score_k=2]
...
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_g=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=green,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/green/cost/musket if @e[tag=cmd,score_gmanpower_min=80,score_ggold_min=10,score_i=-1,score_gflintlock_min=1,score_k=2]
...
#餘額買兵
execute @e[tag=cmd,score_j=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_g=-1,c=1] ~ ~ ~ execute @e[name=barracks,tag=green,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/green/cost/musket if @e[tag=cmd,score_gmanpower_min=80,score_gwood_min=10,score_gwood_ef=0,score_i=-1,score_gflintlock_min=1,score_k=2]
...
#極難AI作弊
execute @e[tag=cmd,score_time_min=100,score_time=100,score_galive_min=1,score_Gdifficulty_min=5,score_gAI=1,score_gflintlock=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=green,name=barracks,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"swordman",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","green"]}
execute @e[tag=cmd,score_time_min=100,score_time=100,score_galive_min=1,score_Gdifficulty_min=5,score_gAI=1,score_gflintlock_min=1,score_grifling=0] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=green,name=barracks,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"musket",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","green"]}
execute @e[tag=cmd,score_time_min=100,score_time=100,score_galive_min=1,score_Gdifficulty_min=5,score_gAI=1] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=green,name=stable,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"light_cavalry",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","green"]}
execute @e[tag=cmd,score_time_min=100,score_time=100,score_galive_min=1,score_Gdifficulty_min=5,score_gAI=1,score_grifling_min=1] ~ ~ ~ execute @e[name=commandcenter,score_AI_b=-1,c=1] ~ ~ ~ execute @e[tag=green,name=barracks,c=3,score_connect_min=1] ~ ~ ~ summon area_effect_cloud ~ ~ ~ {CustomName:"rifleman",CustomNameVisible:0,Duration:2147483647,Radius:0,Tags:["pretrain","green"]}
...
#餘額買軍營
function loop:ai/green/barracks if @e[tag=cmd,score_gwood_min=600,score_ggold_min=700]
#餘額買馬廄(極難)
function loop:ai/green/stable if @e[tag=cmd,score_gwood_min=600,score_ggold_min=400]
#餘額買軍營
...
#餘額升級(極難)
execute @e[name=factory,tag=green,c=1,score_connect_min=1] ~ ~ ~ function loop:ai/green/cost/rifling if @e[tag=cmd,score_ggold_min=500,score_gflintlock_min=1,score_grifling=0]
#孤立資源領土自刪
...
#投降
execute @e[tag=cmd,score_gmanpower_ef=7,score_AI_surrender_min=1] ~ ~ ~ execute @e[name=commandcenter,tag=green] ~ ~ ~ function @@@:suicide if @e[tag=!green,type=vindication_illager,r=33]
#execute @e[name=commandcenter,tag=green] ~ ~ ~ function @@@:suicide if @e[tag=!green,type=shulker,name=territory,r=40]
#自動進攻
function loop:ai/green/module/attack if @e[tag=cmd,score_j_min=1]
function loop:ai/green/module/attack if @e[tag=cmd,score_j=0,score_Gdifficulty_min=2]
