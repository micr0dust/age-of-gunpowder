...
execute @e[tag=pistol,team=team1,score_pistol_min=1,c=1] ~ ~ ~ function loop:timer/pistol/fire if @e[tag=s,team=!team1,r=7,c=1,score_fire_target_min=0,type=!llama]
execute @e[tag=pistol,team=team2,score_pistol_min=1,c=1] ~ ~ ~ function loop:timer/pistol/fire if @e[tag=s,team=!team2,r=7,c=1,score_fire_target_min=0,type=!llama]
execute @e[tag=pistol,team=team3,score_pistol_min=1,c=1] ~ ~ ~ function loop:timer/pistol/fire if @e[tag=s,team=!team3,r=7,c=1,score_fire_target_min=0,type=!llama]
execute @e[tag=pistol,team=team4,score_pistol_min=1,c=1] ~ ~ ~ function loop:timer/pistol/fire if @e[tag=s,team=!team4,r=7,c=1,score_fire_target_min=0,type=!llama]
