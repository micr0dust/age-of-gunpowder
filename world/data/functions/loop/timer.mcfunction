...
scoreboard players set @e[tag=cmd,c=1] j 10
scoreboard players operation @e[tag=cmd,c=1] i %= @e[tag=cmd,c=1] j
execute @e[tag=cmd,c=1,score_i_min=0,score_i=0] ~ ~ ~ execute @e[tag=pistol,score_pistol_min=1,c=1] ~ ~ ~ function loop:timer/pistol/aim
