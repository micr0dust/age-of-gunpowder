...
tellraw @p {"translate":"[ %s ] %s [ %s ] %s%s","color":"yellow","with":[{"keybind":"key.hotbar.8","color":"white"},{"text":"+","color":"white"},{"keybind":"key.drop","color":"white"},{"translate":"aop.hotkey.view","color":"white"},{"translate":"aop.commandcenter","color":"white"}]}
tellraw @p {"translate":"[ %s ] %s [ %s ] %s%s\n","color":"yellow","with":[{"keybind":"key.hotbar.9","color":"white"},{"text":"+","color":"white"},{"keybind":"key.drop","color":"white"},{"translate":"aop.hotkey.view","color":"white"},{"translate":"aop.army","color":"white"}]}
