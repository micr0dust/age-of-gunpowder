...
execute @e[tag=green] ~ ~ ~ execute @e[tag=pretrain,r=0,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
...
execute @e[tag=cmd,score_i=-1] ~ ~ ~ execute @p[score_buildFn_min=60,score_buildFn=69,score_token_min=6,score_token=6,team=green] ~ ~ ~ function loop:trigger/buildFn/buy/green/barracks if @e[tag=building,r=4,c=1,score_connect_min=1]
execute @e[tag=cmd,score_i=-1] ~ ~ ~ execute @p[score_buildFn_min=70,score_buildFn=79,score_token_min=7,score_token=7,team=green] ~ ~ ~ function loop:trigger/buildFn/buy/green/stable if @e[tag=building,r=4,c=1,score_connect_min=1]
...
execute @p[score_buildFn_min=60,score_buildFn=79,team=green] ~ ~ ~ function loop:trigger/buildFn/buy/poplimit if @e[tag=cmd,score_i=0]
