...
execute @p[score_buildFn_min=60,score_buildFn=69,score_token_min=6,score_token=6,team=blue] ~ ~ ~ function loop:trigger/buildFn/buy/blue/barracks if @e[tag=building,r=4,c=1,score_connect_min=1]
execute @p[score_buildFn_min=70,score_buildFn=79,score_token_min=7,score_token=7,team=blue] ~ ~ ~ function loop:trigger/buildFn/buy/blue/stable if @e[tag=building,r=4,c=1,score_connect_min=1]
