...
execute @p[score_buildFn_min=60,score_buildFn=69,score_token_min=6,score_token=6,team=yellow] ~ ~ ~ function loop:trigger/buildFn/buy/yellow/barracks if @e[tag=building,r=4,c=1,score_connect_min=1]
execute @p[score_buildFn_min=70,score_buildFn=79,score_token_min=7,score_token=7,team=yellow] ~ ~ ~ function loop:trigger/buildFn/buy/yellow/stable if @e[tag=building,r=4,c=1,score_connect_min=1]
