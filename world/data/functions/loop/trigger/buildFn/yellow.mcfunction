...
execute @e[tag=yellow] ~ ~ ~ execute @e[tag=pretrain,r=0,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd,c=1] i 1
...
execute @e[tag=cmd,c=1,score_i=-1] ~ ~ ~ execute @p[score_buildFn_min=60,score_buildFn=69,score_token_min=6,score_token=6,team=yellow] ~ ~ ~ function loop:trigger/buildFn/buy/yellow/barracks if @e[tag=building,r=4,c=1,score_connect_min=1]
execute @e[tag=cmd,c=1,score_i=-1] ~ ~ ~ execute @p[score_buildFn_min=70,score_buildFn=79,score_token_min=7,score_token=7,team=yellow] ~ ~ ~ function loop:trigger/buildFn/buy/yellow/stable if @e[tag=building,r=4,c=1,score_connect_min=1]
...
execute @p[score_buildFn_min=60,score_buildFn=79,team=yellow] ~ ~ ~ function loop:trigger/buildFn/buy/poplimit if @e[tag=cmd,c=1,score_i=0]
