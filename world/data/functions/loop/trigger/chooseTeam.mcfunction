...
execute @p[score_chooseTeam_min=11,score_chooseTeam=11,team=red,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd] rteam 1
execute @p[score_chooseTeam_min=12,score_chooseTeam=12,team=blue,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd] bteam 1
execute @p[score_chooseTeam_min=13,score_chooseTeam=13,team=yellow,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd] yteam 1
execute @p[score_chooseTeam_min=14,score_chooseTeam=14,team=green,c=1] ~ ~ ~ scoreboard players add @e[tag=cmd] gteam 1
