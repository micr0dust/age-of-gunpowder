...
execute @e[tag=cmd,c=1,score_rteam_min=5] ~ ~ ~ scoreboard players set @e[tag=cmd,c=1] rteam 0
execute @e[tag=cmd,c=1,score_bteam_min=5] ~ ~ ~ scoreboard players set @e[tag=cmd,c=1] bteam 0
execute @e[tag=cmd,c=1,score_yteam_min=5] ~ ~ ~ scoreboard players set @e[tag=cmd,c=1] yteam 0
execute @e[tag=cmd,c=1,score_gteam_min=5] ~ ~ ~ scoreboard players set @e[tag=cmd,c=1] gteam 0
