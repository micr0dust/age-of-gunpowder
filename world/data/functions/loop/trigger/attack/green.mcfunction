...
execute @e[tag=cmd,c=1,score_gswordman_min=1,score_gspearman=0] ~ ~ ~ execute @e[tag=goutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:4899L,UUIDLeast:4899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.13f}],Silent:1,Tags:["attacker","gattacker","green"]}
execute @e[tag=cmd,c=1,score_gswordman=0,score_gspearman_min=1] ~ ~ ~ execute @e[tag=goutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:4899L,UUIDLeast:4899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.13f}],Silent:1,Tags:["attacker","gattacker","green"]}
execute @e[tag=cmd,c=1,score_gswordman_min=1,score_gspearman_min=1] ~ ~ ~ execute @e[tag=goutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:4899L,UUIDLeast:4899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.13f}],Silent:1,Tags:["attacker","gattacker","green"]}
execute @e[tag=cmd,c=1,score_gswordman=0,score_gspearman=0,score_gmusket_min=1] ~ ~ ~ execute @e[tag=goutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:4899L,UUIDLeast:4899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.19f}],Silent:1,Tags:["attacker","gattacker","green"]}
execute @e[tag=cmd,c=1,score_gswordman=0,score_gspearman=0,score_gmusket=0,score_grider_min=1] ~ ~ ~ execute @e[tag=goutset,c=1] ~ ~ ~ summon minecraft:husk ~ 48 ~ {PersistenceRequired:1b,UUIDMost:4899L,UUIDLeast:4899L,Attributes:[{Name:"generic.followRange",Base:152},{Name:"generic.knockbackResistance",Base:1f},{Name:"generic.movementSpeed",Base:0.29f}],Silent:1,Tags:["attacker","gattacker","green"]}
...
scoreboard players operation @e[tag=cmd,c=1] g_musket = @e[tag=cmd,c=1] gmusket
scoreboard players operation @e[tag=cmd,c=1] g_swordman = @e[tag=cmd,c=1] gswordman
scoreboard players operation @e[tag=cmd,c=1] g_spearman = @e[tag=cmd,c=1] gspearman
scoreboard players operation @e[tag=cmd,c=1] g_rider = @e[tag=cmd,c=1] grider
