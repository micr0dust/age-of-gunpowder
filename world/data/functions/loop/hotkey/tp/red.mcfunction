...
execute @p[team=red,score_keyQ=7,score_keyQ_min=7,score_drop_min=1] ~ ~ ~ execute @e[tag=cmd,c=1] ~ ~ ~ scoreboard players tag @e[name=commandcenter,score_Rviewed=0,c=1] add Rviewing
execute @p[team=red,score_keyQ=8,score_keyQ_min=8,score_drop_min=1] ~ ~ ~ execute @e[tag=cmd,c=1] ~ ~ ~ scoreboard players tag @e[tag=red,type=vindication_illager,score_Rviewed=0,c=1] add Rviewing
