...
execute @p[team=blue,score_keyQ=7,score_keyQ_min=7,score_drop_min=1] ~ ~ ~ execute @e[tag=cmd,c=1] ~ ~ ~ scoreboard players tag @e[tag=blue,name=commandcenter,score_Bviewed=0,c=1] add Bviewing
execute @p[team=blue,score_keyQ=8,score_keyQ_min=8,score_drop_min=1] ~ ~ ~ execute @e[tag=cmd,c=1] ~ ~ ~ scoreboard players tag @e[tag=!blue,name=commandcenter,score_Bviewed=0,c=1] add Bviewing
...
execute @p[team=blue,score_keyQ=7,score_keyQ_min=7,score_drop_min=1] ~ ~ ~ execute @e[tag=blue,name=commandcenter,score_Bviewed=0,c=1] ~ ~ ~ tp @p[team=blue] ~9 70 ~9 135 37
execute @p[team=blue,score_keyQ=8,score_keyQ_min=8,score_drop_min=1] ~ ~ ~ execute @e[tag=!blue,name=commandcenter,score_Bviewed=0,c=1] ~ ~ ~ tp @p[team=blue] ~-9 70 ~-9 -45 37
execute @p[team=blue,score_i_min=1] ~ ~ ~ scoreboard players tag @e[tag=Bviewed] remove Bviewed
execute @e[tag=building,score_Bviewed_min=1,c=1] ~ ~ ~ function loop:hotkey/tp/blue if @p[team=blue,score_i_min=1]
