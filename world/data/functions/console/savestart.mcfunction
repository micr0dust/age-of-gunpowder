...
scoreboard players operation @e[tag=cmd,c=1] rteam = @e[tag=saveA] Rsave_team
scoreboard players operation @e[tag=cmd,c=1] bteam = @e[tag=saveA] Bsave_team
scoreboard players operation @e[tag=cmd,c=1] yteam = @e[tag=saveA] Ysave_team
scoreboard players operation @e[tag=cmd,c=1] gteam = @e[tag=saveA] Gsave_team
