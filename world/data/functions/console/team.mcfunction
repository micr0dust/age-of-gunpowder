...
scoreboard players set @e[tag=cmd] i 0
scoreboard players set @e[tag=cmd] j 0
execute @p[team=red] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @p[team=blue] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @p[team=yellow] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @p[team=green] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @e[tag=cmd,score_rAI_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @e[tag=cmd,score_bAI_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @e[tag=cmd,score_yAI_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @e[tag=cmd,score_gAI_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] i 1
execute @e[tag=cmd,score_rteam_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] j 1
execute @e[tag=cmd,score_bteam_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] j 1
execute @e[tag=cmd,score_yteam_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] j 1
execute @e[tag=cmd,score_gteam_min=1] ~ ~ ~ scoreboard players add @e[tag=cmd] j 1
...
execute @e[tag=cmd,score_i=2,score_j=1] ~ ~ ~ scoreboard players set @e[tag=cmd] rteam 1
execute @e[tag=cmd,score_i=2,score_j=1] ~ ~ ~ scoreboard players set @e[tag=cmd] bteam 2
execute @e[tag=cmd,score_i=2,score_j=1] ~ ~ ~ scoreboard players set @e[tag=cmd] yteam 3
execute @e[tag=cmd,score_i=2,score_j=1] ~ ~ ~ scoreboard players set @e[tag=cmd] gteam 4
