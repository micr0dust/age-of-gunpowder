...
scoreboard players set @e[tag=cmd,c=1,c=1] rmusket 1
scoreboard players set @e[tag=cmd,c=1,c=1] rswordman 1
scoreboard players set @e[tag=cmd,c=1,c=1] rspearman 1
scoreboard players set @e[tag=cmd,c=1,c=1] rrider 1
scoreboard players set @e[tag=cmd,c=1,c=1] bmusket 1
scoreboard players set @e[tag=cmd,c=1,c=1] bswordman 1
scoreboard players set @e[tag=cmd,c=1,c=1] bspearman 1
scoreboard players set @e[tag=cmd,c=1,c=1] brider 1
scoreboard players set @e[tag=cmd,c=1,c=1] ymusket 1
scoreboard players set @e[tag=cmd,c=1,c=1] yswordman 1
scoreboard players set @e[tag=cmd,c=1,c=1] yspearman 1
scoreboard players set @e[tag=cmd,c=1,c=1] yrider 1
scoreboard players set @e[tag=cmd,c=1,c=1] gmusket 1
scoreboard players set @e[tag=cmd,c=1,c=1] gswordman 1
scoreboard players set @e[tag=cmd,c=1,c=1] gspearman 1
scoreboard players set @e[tag=cmd,c=1,c=1] grider 1
#-----------------------------------------------------

#隨機變數---------------------------------------------
#terrain
scoreboard objectives add terrainRNG dummy
scoreboard players set @e[tag=cmd,c=1,c=1] terrainRNG 1
#team
scoreboard objectives add teamRNG dummy
scoreboard players set @e[tag=cmd,c=1,c=1] teamRNG 1
#time
scoreboard objectives add time dummy
scoreboard players set @e[tag=cmd,c=1,c=1] time 1
#-----------------------------------------------------
...
scoreboard players set @e[tag=cmd,c=1,c=1] stage 0
scoreboard objectives add branch dummy
scoreboard players set @e[tag=cmd,c=1,c=1] branch 0
#┌────────────────┬──────────────────────────────────────────────────────────
#│     stage      │                      branch
#├────────────────┼─────┬────────────────────────────────────────────────────
...
scoreboard players set @e[tag=cmd,c=1,c=1] init_manpower 300
scoreboard players set @e[tag=cmd,c=1,c=1] init_wood 100
scoreboard players set @e[tag=cmd,c=1,c=1] init_gold 0
#隊伍
#[1]--------------------------------------------------
...
scoreboard players set @e[tag=cmd,c=1,c=1] bteam 0
...
scoreboard players set @e[tag=cmd,c=1,c=1] gAI 0
scoreboard objectives add Gpopulation dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Gpopulation 0
#-----------------------------------------------------
function console:trigger

#-地形----------------------------------------------
scoreboard objectives add terrain dummy
scoreboard players set @e[tag=cmd,c=1,c=1] terrain 0
#---------------------------------------------------
...
scoreboard players set @e[tag=cmd,c=1,c=1] rwheellock 0
scoreboard players set @e[tag=cmd,c=1,c=1] rflintlock 0
scoreboard players set @e[tag=cmd,c=1,c=1] rrifling 0
scoreboard players set @e[tag=cmd,c=1,c=1] rfield_gun 0
#blue
...
scoreboard players set @e[tag=cmd,c=1,c=1] bwheellock 0
scoreboard players set @e[tag=cmd,c=1,c=1] bflintlock 0
scoreboard players set @e[tag=cmd,c=1,c=1] brifling 0
scoreboard players set @e[tag=cmd,c=1,c=1] bfield_gun 0
#yellow
...
scoreboard players set @e[tag=cmd,c=1,c=1] ywheellock 0
scoreboard players set @e[tag=cmd,c=1,c=1] yflintlock 0
scoreboard players set @e[tag=cmd,c=1,c=1] yrifling 0
scoreboard players set @e[tag=cmd,c=1,c=1] yfield_gun 0
#green
...
scoreboard players set @e[tag=cmd,c=1,c=1] gwheellock 0
scoreboard players set @e[tag=cmd,c=1,c=1] gflintlock 0
scoreboard players set @e[tag=cmd,c=1,c=1] grifling 0
scoreboard players set @e[tag=cmd,c=1,c=1] gfield_gun 0
#---------------------------------------------------
#垃圾
...
scoreboard players set @e[tag=cmd,c=1,c=1] Runits 0
scoreboard objectives add Rmanpowers dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Rmanpowers 0
scoreboard objectives add Rwoods dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Rwoods 0
scoreboard objectives add Rgolds dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Rgolds 0
scoreboard objectives add Rterritories dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Rterritories 0
#B
scoreboard objectives add Bunits dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Bunits 0
scoreboard objectives add Bmanpowers dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Bmanpowers 0
scoreboard objectives add Bwoods dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Bwoods 0
scoreboard objectives add Bgolds dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Bgolds 0
scoreboard objectives add Bterritories dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Bterritories 0
#Y
scoreboard objectives add Yunits dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Yunits 0
scoreboard objectives add Ymanpowers dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Ymanpowers 0
scoreboard objectives add Ywoods dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Ywoods 0
scoreboard objectives add Ygolds dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Ygolds 0
scoreboard objectives add Yterritories dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Yterritories 0
#G
scoreboard objectives add Gunits dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Gunits 0
scoreboard objectives add Gmanpowers dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Gmanpowers 0
scoreboard objectives add Gwoods dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Gwoods 0
scoreboard objectives add Ggolds dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Ggolds 0
scoreboard objectives add Gterritories dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Gterritories 0
#-存檔----------------------------------------------
#隊伍
...
scoreboard players set @e[tag=cmd,c=1,c=1] hotKey 1
#副手偵測
...
scoreboard players set @e[tag=cmd,c=1,c=1] AI_surrender 1
scoreboard objectives add init_tech dummy
scoreboard players set @e[tag=cmd,c=1,c=1] init_tech 0
scoreboard objectives add Rdifficulty dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Rdifficulty 2
scoreboard objectives add Bdifficulty dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Bdifficulty 2
scoreboard objectives add Ydifficulty dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Ydifficulty 2
scoreboard objectives add Gdifficulty dummy
scoreboard players set @e[tag=cmd,c=1,c=1] Gdifficulty 2
